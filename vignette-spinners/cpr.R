...
#' This conclusion is supported by looking at the residual sum of squares.
...
#'
#' The summary above reports two additional columns,
{{ backtick("Pr(>w_(1))", dequote = TRUE) %s% " and " %s% backtick(elbow) %s% "."}}
#' The former is the p-value for testing is the knot with the lowest influence
#' has a non-zero influence.  The latter is the "elbow" in a plot of the
#' residual sum of squares by index.
