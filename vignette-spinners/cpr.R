...
{{backtick("bsplines()", dequote = TRUE)}}
...
#' By default
{{ backtick("splines::bs()", dequote = TRUE) }}
...
#'
#' Example: for the
{{ backtick("cpr::bsplines()", dequote = TRUE) }}
...
#' in the
{{ qwraps2::backtick("cp()", dequote = TRUE) }}
...
{{ qwraps2::backtick("influence_of_iknots()", dequote = TRUE) %s% "." }}
...
{{ qwraps2::backtick("cpr()", dequote = TRUE) }}
#' on a
