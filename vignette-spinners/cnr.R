...
#'
#'
#' The control polygon reduction methods for univariable-functions can be
#' extended to multivariable funtions by generalizing control polygons to
#' control nets.
#'
#' # Tensor Products of B-Splines
#'
#' Where univariable functions of B-splines:
#'
#' \begin{equation}
#'   f \left( x \right) =
...
#' \end{equation}
#'
#' we extend to mutlivariable $m$-dimensional B-spline function, built on $m$
...
#' assesses the influence of each internal knot, omits the least influencial,
...
#' $x$ on the other margins definign the polynomial coeficients.  We suggest
...
#'
#' The least influencial knot is $\xi_{1,4}$ and the most influencial knot is
#' $\xi_{2,5}.$
