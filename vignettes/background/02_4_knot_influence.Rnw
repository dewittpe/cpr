...
iwghts <- cpr::weigh_iknots(xi, theta)
iwghts
...
plots[[1]]
@
  \caption{Influence Weight of $\xi_5 = \Sexpr{iwghts[1, 1]}$
...
plots[[2]]
@
  \caption{Influence Weight of $\xi_6 = \Sexpr{iwghts[2, 1]}$
...
plots[[3]]
@
  \caption{Influence Weight of $\xi_7 = \Sexpr{iwghts[3, 1]}$
...
plots[[4]]
@
  \caption{Influence Weight of $\xi_8 = \Sexpr{iwghts[4, 1]}$
...
plots[[5]]
@
  \caption{Influence Weight of $\xi_8 = \Sexpr{iwghts[5, 1]}$
