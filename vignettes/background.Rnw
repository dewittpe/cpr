...
<<basis, fig.cap = "Cool", fig.width = 4, fig.height = 4>>=
# generate the plot in Figure \ref{fig:basis}
# If you do not like this plot, or you just want to get at
# the data used to create it: plot_data <- plot(bmat)$data
plot(bmat)
@
